...
export default function IngressosPage() {
  ...
  const avaliacaoGoogle =
    "⭐ 4,7/5 no Google • 11.557 avaliações";
  ...
  const confianca = [
    {
      ...
      texto:
        "Pagamento protegido via Pix e confirmação automática no sistema.",
    },
    {
      icone: "⚡",
      titulo: "Confirmação Imediata",
      texto:
        "Após o pagamento, seu ingresso digital é gerado automaticamente.",
    },
    {
      icone: "🎟️",
      titulo: "QR Code Exclusivo",
      texto:
        "Entrada rápida e segura na portaria com validação individual.",
    },
    {
      icone: "🌄",
      titulo: "Aberto Todos os Dias",
      texto:
        "Funcionamento diário das 08h às 17h30.",
    },
  ];
  ...
  async function lidarComReenvio(
    ...
    if (!pedidoId.trim()) {
      setMensagemReenvio({
        tipo: "erro",
        texto:
          "Por favor, informe o ID do pedido.",
      });
    ...
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#06150f] via-[#0b2418] to-[#f3f7ef] text-white">
            ...
            <div className="max-w-4xl">
              ...
              <div className="mt-6 inline-flex max-w-3xl rounded-2xl border border-cyan-200/30 bg-cyan-500/15 px-5 py-4 shadow-2xl backdrop-blur-md">
                ...
                <p className="font-black leading-relaxed text-cyan-50">
                  🏆 Conheça o primeiro
                  Elevador Panorâmico da
                  América Latina com 100
                  metros de altura.
                </p>
      ...
      {modalReenviarAberto && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
          ...
          <div className="w-full max-w-md rounded-3xl border border-emerald-500/30 bg-emerald-950 p-6 text-white shadow-2xl">
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-xl border border-white/20 bg-white/10 p-4 font-semibold text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400"
                />
            ...
            <div className="border-t border-cyan-200/20 bg-gradient-to-b from-[#07150f] to-[#0d2018] p-5 md:hidden">
              ...
              <div className="rounded-[1.75rem] border border-white/10 bg-white/[0.06] p-5 shadow-2xl">
                ...
                <div className="mt-5 rounded-xl border border-orange-300/30 bg-orange-500/15 p-4 text-sm font-semibold leading-relaxed text-orange-50">
                  ⚠️ O ingresso do
                  Elevador Panorâmico é
                  vendido separadamente
                  do ingresso de entrada
                  do Parque Mundo Novo.
                </div>
      ...
      >
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 text-lg leading-relaxed text-emerald-50/85 shadow-2xl">
            O Parque Mundo Novo reúne
            paisagens naturais,
            cachoeiras, mirantes,
            restaurante, camping e
            atrações para visitantes
            que desejam aproveitar o
            melhor da Serra
            Catarinense. O parque
            também é Pet Friendly e o
            camping aceita motorhomes.
          </div>
      ...
      <section className="px-4 pb-20">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-emerald-50/75">
            Natureza, aventura,
            estrutura para famílias e
            experiências para
            aproveitar em um dos
            destinos mais bonitos da
            Serra Catarinense.
          </p>
                    ...
                    {item.parceiro ? (
                      ...
                      <div className="mt-6 space-y-3">
                        ...
                        <button
                          ...
                          className="w-full rounded-xl bg-emerald-400 px-4 py-4 font-black text-emerald-950 shadow-lg transition hover:-translate-y-1 hover:bg-emerald-300"
                        >
                          🔐 Já sou parceiro
                        </button>
                        ...
                        <button
                          ...
                          className="w-full rounded-xl border border-white/30 bg-white/10 px-4 py-3 font-bold text-white shadow-lg backdrop-blur-sm transition hover:-translate-y-1 hover:bg-white/20"
                        >
                          📝 Quero me cadastrar
                        </button>
      ...
      <section
        ...
        className="px-4 py-20 text-zinc-800"
      >
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 rounded-[2rem] bg-emerald-50 p-5 font-semibold text-emerald-950">
            ...
            <p>
              Passados os 7 dias ou
              após a utilização do
              ingresso, não é possível
              solicitar reembolso.
            </p>
            ...
            <p className="mt-2">
              ...
              pedido. O reembolso é
              feito pelo mesmo meio de
              pagamento utilizado na
              compra e pode levar
              alguns dias úteis,
              conforme prazo do banco
              ou operadora.
