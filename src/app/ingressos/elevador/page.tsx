          ...
          <div className="flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
            ...
            <div>
              ...
              <p className="mt-4 max-w-3xl text-lg leading-relaxed text-white/90 sm:text-xl">
                Viva uma experiência incrível com vista
                panorâmica do Parque Mundo Novo.
              </p>
          ...
          <div className="rounded-3xl border border-white/20 bg-white/95 p-6 text-gray-900 shadow-2xl backdrop-blur-md">
            ...
            <div className="mb-6 rounded-2xl border border-orange-300 bg-orange-50 p-4 text-sm leading-relaxed text-orange-950">
              ...
              <ul className="list-disc space-y-2 pl-5">
                <li>
                  Este ingresso é válido exclusivamente para
                  o{" "}
                  <strong>
                    Elevador Panorâmico
                  </strong>
                ...
                <li>
                  O Elevador Panorâmico não substitui o
                  ingresso de entrada do Parque Mundo Novo.
                </li>

                <li>
                  Para utilizar o elevador é necessário
                  possuir também um ingresso válido de
                  acesso ao parque.
                </li>
              </ul>
            </div>
