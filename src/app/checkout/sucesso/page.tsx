...
export default function SucessoPage() {
  ...
  useEffect(() => {
    async function carregarPedido() {
      try {
        ...
        setStatus("Não foi possível carregar o pedido");
      } finally {
        setCarregando(false);
      }
    }
  ...
  function baixarQrCode() {
    ...
    link.href = qrCode;
    link.download = `QR-Code-Ingresso-${codigoIngresso}.png`;
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
              ...
              <div>
                ...
                <p className="mt-3 leading-relaxed">
                  Para entrar no Parque Mundo Novo, é obrigatório apresentar o{" "}
                  <strong>QR Code oficial do ingresso</strong>, impresso ou
                  diretamente pelo celular.
                </p>

                <p className="mt-3 leading-relaxed">
                  O comprovante do Pix serve somente para comprovar o pagamento
                  e <strong>não libera a entrada no parque</strong>.
                </p>

                <p className="mt-3 font-bold leading-relaxed">
                  O QR Code será lido e validado na portaria e poderá ser
        ...
        <section className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_1fr]">
          <div className="rounded-3xl border border-white/20 bg-white/95 p-6 text-gray-900 shadow-2xl">
            ...
            <div className="space-y-4">
              {pedidoId && <Info label="Número do pedido" value={pedidoId} />}
            ...
            {pago ? (
              <>
                <div className="mt-6 rounded-2xl border border-green-300 bg-green-100 p-4 text-sm leading-relaxed text-green-900">
                  <strong>Ingresso válido:</strong> pagamento confirmado
                  automaticamente pelo Sicredi e valor conferido com o pedido.
                </div>

                <div className="mt-4 rounded-2xl border border-blue-300 bg-blue-50 p-4 text-sm leading-relaxed text-blue-950">
                  <strong>Apresentação obrigatória:</strong> leve este ingresso
                  com o QR Code no celular ou impresso para validação na
                  portaria.
                </div>
              </>
            ) : valorDivergente ? (
              ...
              <div className="mt-6 rounded-2xl border border-yellow-300 bg-yellow-100 p-4 text-sm leading-relaxed text-yellow-900">
                ...
                prazo informado. O QR Code do ingresso será liberado somente
                após a confirmação automática do pagamento.
              </div>
            )}
          </div>
          ...
          <div className="rounded-3xl border border-white/20 bg-white/95 p-6 text-center text-gray-900 shadow-2xl">
            ...
            {pago ? (
              <p className="mb-5 text-sm font-semibold text-gray-600">
                Apresente este QR Code na portaria do Parque Mundo Novo.
              </p>
            ) : (
            ...
            <div className="flex justify-center">
              {carregando ? (
                ...
                <div className="flex h-[280px] w-[280px] items-center justify-center rounded-3xl border border-yellow-300 bg-yellow-100 p-6 text-center font-bold text-yellow-900">
                  Efetue o pagamento para liberar o QR Code oficial do ingresso.
                </div>
              )}
            </div>
        ...
        {pago && pedidoId && (
          <section className="mt-8 rounded-3xl border border-white/20 bg-white/95 p-6 text-gray-900 shadow-2xl">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-relaxed text-gray-600">
              Baixe o ingresso e guarde no celular ou imprima antes de ir ao
              parque. Não apresente apenas o comprovante do Pix.
            </p>
        ...
        <section className="mt-8 rounded-3xl border border-yellow-300 bg-yellow-100 p-5 text-yellow-950 shadow-xl">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed">
            <li>
              Apresente o QR Code oficial do ingresso impresso ou pelo celular.
            </li>

            <li>
              O comprovante de pagamento Pix não é aceito como ingresso.
            </li>

            <li>
              A equipe da portaria fará a leitura e validação do QR Code.
            </li>

            <li>
              Depois de validado, o QR Code não poderá ser utilizado novamente.
            </li>

            <li>
              Um documento oficial com foto poderá ser solicitado na portaria.
            </li>
          </ul>
        </section>
